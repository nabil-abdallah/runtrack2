...
<form action="index.php" method="post">
    ...
    <label for="ecart" class="hid">choisisez votre ecart si l'option cesar à été choisi</label><input class="hid" type="number" name="ec" id="ecart" placeholder="2 par défaut">
